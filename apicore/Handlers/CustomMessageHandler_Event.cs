...
namespace apicore.Handlers
{
    public partial class CustomMessageHandler
    {
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            responseMessage.Content = GetWelcomeText();
            ...
            if (requestMessage.EventKey.StartsWith("qrscene_"))
            {
                ...
                Task.Run(() => CustomApi.SendTextAsync(null, WeixinOpenId, $"二维码参数为{sceneId}"));
            }
        ...
        public override IResponseMessageBase OnEvent_TemplateSendJobFinishRequest(RequestMessageEvent_TemplateSendJobFinish requestMessage)
        {
            ...
            try
            {
                var msg = string.Format(@"已向您发送模板消息
状态：{0}
MsgId：{1}
（这是一条来自MessageHandler的客服消息）", requestMessage.Status, requestMessage.MsgID);
